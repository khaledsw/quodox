<div class="my_meta_control">
    <p style="float:right">
        <a href="#" class="dodelete-ourteacher button">Remove All</a>
    </p>
    <div style="clear: both;margin-bottom: 15px;" ></div>
    <?php while($mb->have_fields_and_multi('ourteacher',array('length' => 2))): ?>
        <?php $mb->the_group_open(); ?>
        <a href="#" class="dodelete button">Remove</a>
        <?php $mb->the_field('socialName'); ?>
        <label><?php esc_html_e('Name', 'g5plus-academia'); ?></label>
        ...
        <label><?php esc_html_e('Link', 'g5plus-academia'); ?></label>
        <input class="form-control" type="text" name="<?php esc_attr($mb->the_name()); ?>" value="<?php esc_attr($mb->the_value()); ?>"/>

        <?php $mb->the_field('socialIcon'); ?>
        <label><?php esc_html_e('Icon', 'g5plus-academia'); ?></label>
        ...
        <input title="Click to browse icon" style="width:35%;" class="browse-icon button-secondary" type="button" value="Browse" >
        <span class="icon-preview"><i class=""></i></span>
        <?php $mb->the_group_close(); ?>
    <?php endwhile; ?>
    <div style="clear: both;"></div>
    <p>
        <a href="#" class="docopy-ourteacher button"><?php esc_html_e('Add Social', 'g5plus-academia'); ?></a>
    </p>
</div>
<style>
    ...
    .wpa_group.wpa_group-ourteacher {
...
<script type="text/javascript">
    jQuery(function(){
        "use strict";
        jQuery('#wpa_loop-ourteacher').sortable();
    });
</script>