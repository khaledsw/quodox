...
if ( ! class_exists( 'WC_Product_Cat_List_Walker' ) ) :
    ...
    class WC_Product_Cat_List_Walker extends Walker {
        ...
        public function start_el( &$output, $cat, $depth = 0, $args = array(), $current_object_id = 0 ) {
            ...
            if($args['show_count']){
                $output .=  '"><div class="dot"></div><a href="' . get_term_link( (int) $cat->term_id, $this->tree_type ) . '">' . esc_html($cat->name) . '</a>';
            }else{
                $output .=  '"><a href="' . get_term_link( (int) $cat->term_id, $this->tree_type ) . '">' . esc_html($cat->name) . '</a>';
            }
            if ( $args['show_count'] ) {
