        ...
        function g5plus_woocommerce_add_custom_general_fields() {
            ...
            woocommerce_wp_checkbox(
                array(
                    ...
                    'label' => esc_html__('New Course', 'g5plus-academia')
                )
            );
            woocommerce_wp_checkbox(
                array(
                    'id' => 'g5plus_product_hot',
                    'label' => esc_html__('Popular Course', 'g5plus-academia')
                )
            );

woocommerce_wp_checkbox(
                array(
                    'id' => 'g5plus_product_upcoming',
                    'label' => esc_html__('Upcoming Course', 'g5plus-academia')
                )
            );
            echo '</div>';
        }
...
$g5plus_product_upcoming = isset($_POST['g5plus_product_upcoming']) ? 'yes' : 'no';
            update_post_meta($post_id, 'g5plus_product_upcoming', $g5plus_product_upcoming);
    ...
    if (!function_exists('g5plus_columns_into_product_list')) {
        function g5plus_columns_into_product_list($defaults) {
            ...
            $defaults['g5plus_product_hot'] = esc_html__('Popular','g5plus-academia');
$defaults['g5plus_product_upcoming'] = esc_html__('Upcoming','g5plus-academia');
            return $defaults;
        }
        ...
        function g5plus_column_into_product_list($column, $post_id) {
            switch ($column) {
                ...
                case 'g5plus_product_hot':
                    ...
                    break;
case 'g5plus_product_upcoming':
                    echo get_post_meta($post_id, 'g5plus_product_upcoming', true);
                    break;
            }
        }
...
'g5plus_product_upcoming' => 'g5plus_product_upcoming'
            );
        }
...
if ('g5plus_product_upcoming' == $orderby) {
                $query->set('meta_key', 'g5plus_product_upcoming');
                $query->set('orderby', 'meta_value_num');
            }
        }
